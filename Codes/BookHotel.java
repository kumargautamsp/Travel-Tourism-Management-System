...
public class BooKHotel extends JFrame implements ActionListener {
        ...
        try{
            Conn c =new Conn();//here we have created a conn class to connect with the mysql setver
       ...
       add(cfood);
        ...
        back.addActionListner(this);
        add(back);

        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/book.jpg")); //Add image
        Image i2=i1.getImage().getScaledInstance(500,300,Image.SCALE_DEFAULT);
        ImageIcon i3=new ImageIcon(i2);
        JLabel l12=new JLabel (i3);
        l12.setBounds(500,50,6 00,300);
        add(l12);
...
public void actionPerformed(ActionEvent ae)
        ...
        if(ae.getSource() == checkprice) {
         try {
             ...
             while(rs.next())
             {
                 ...
                 int ac=Integer.parseInt(rs.getString("AC-ROOM "));
        ...
        try {
        Conn c=new Conn();
        c.s.executeUpdate("insert into bookhotel values('"+labelusername.getText()+"','"+chotel.getSelectedItem()+"','"+tfpersons.getText()+"','"+tfdays+"','"+cac.getSelectedItem()+labelid.getText()+"','"+cfood.getSelectedItem()+"','" +labelnumber.getText()+"','"+labelphone.getText()+"','"+labelprice.getText()+"')");
