...
{	
	...
	ForgetPassword()
	{
		...
		lblusername.setFont(new Font("SAN_SARIF",Font.PLAIN,14));
		p1.add(lblusername);
		...
		lblname.setFont(new Font("SAN_SARIF",Font.PLAIN,14));
		p1.add(lblname);
		...
		lblquestion.setFont(new Font("SAN_SARIF",Font.PLAIN,14));
		p1.add(lblquestion);
		...
		lblanswer.setFont(new Font("SAN_SARIF",Font.PLAIN,14));
		p1.add(lblanswer);
		...
		lblpassword.setFont(new Font("SAN_SARIF",Font.PLAIN,14));
		p1.add(lblpassword);
