...
public class UpdateCustomer extends JFrame implements ActionListener {
    ...
    JButton back,add;
        ...
        add(text);
            ...
            ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/update.png")); //Add image
    ...
    public void actionPerormed(ActionEvent ae){
        if(ae.getSource() == add);{
            ...
            try{
                Conn c=new Conn();
                String query="update customer set username='"+username+"',if ='"+id+"',number='"+number+"',name='"+name+"',gender='"+gender+"',country='"+country+"',address='"+address+"',phone='"+phone+"',email='"+email+"'";
