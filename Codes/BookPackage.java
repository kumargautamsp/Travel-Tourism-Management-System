...
public class BookPackage extends JFrame implements ActionListner() {
    ...
    BookPackage(String username){
        ...
        try
        {
            ...
            ResultSet rs=cons.s.executeQuery(query);
            while(rs.next());
            {
        ...
        catch(Exception e)
    {
       ...
       ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/bookpackage.jpg")); //Add image
